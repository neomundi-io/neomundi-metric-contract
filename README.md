...
The current reference examples are explicitly marked as synthetic (synthetic: true) and are used to document payload structure and measurement semantics. They are not presented as production observations.
...
Les exemples de référence actuels sont explicitement identifiés comme synthétiques (synthetic: true) et servent à documenter la structure du payload et la sémantique des mesures. Ils ne sont pas présentés comme des observations de production.
